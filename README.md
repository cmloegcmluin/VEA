...
[VEA](https://en.xen.wiki/w/VEA) utilities, implemented in [Wolfram Language](https://www.wolfram.com/language/) (formerly Mathematica), a popular and capable programming language for working with math. 

This library relies on the [RTT library](https://github.com/cmloegcmluin/RTT). You will need to add the RTT functions to scope and then you will be able to use these. Many concepts and conventions here build upon those in that library.
